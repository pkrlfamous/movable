...
export default function Home() {
  ...
  // Updated handleSubmit accepts an optional prompt parameter
  const handleSubmit = async (customPrompt?: string) => {
    const finalPrompt = customPrompt || prompt;
    const res = await axios.post("http://localhost:5001/api", { prompt: finalPrompt, tool });
    console.log("Submitting prompt and tool:", { prompt: finalPrompt, tool });
      ...
      try {
        ...
        mediaRecorder.onstop = async () => {
          ...
          try {
            ...
            // Directly use the transcription value to submit
  ...
  return (
    <main className="min-h-screen bg-gray-900 text-white p-6 flex flex-col items-center">
      <h1 className="text-5xl font-bold mb-8 mt-4 text-transparent bg-clip-text bg-gradient-to-r from-green-400 via-blue-500 to-purple-500 leading-20">
        Movable Agent
      </h1>
      ...
      <p className="mt-2 mb-2">
        {isRecording
          ? "Recording in progress... Tap the microphone to stop and save."
